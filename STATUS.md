...
- Implement and review descriptor-bound full-layout validation and safe extraction before acquiring EdAcc; reject traversal, links, sparse/special entries, duplicates/case-fold collisions, unexpected members, and unbounded expansion. Common Voice still needs owner term/token acceptance. Then validate both private corpora and run the exact canonical-strata wrapper; AMI and Harper source preparation are complete. Never change runtime defaults from development evidence (ADR-0112/0113/0115/0116/0117/0120/0122/0127/0130/0131).
