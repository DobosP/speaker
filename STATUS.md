...
- Current non-real logic gate: 7,520 passing checks as 7,489 low-priority broad passes plus 31 exact-condition reruns (logging enabled, repository lock mode 600, and async loop timing isolated); 14 skipped, 24 model-only deselected, 11 warnings. Moonshine external-endpoint focused gate: 326 + 2 model deselections; exact worker smoke 1. BPE focused gate: 366 + 1 optional model skip; current APM/DTD 6.
