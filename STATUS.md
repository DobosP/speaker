...
- Keep parakeet.cpp isolated; prioritize a disjoint Common Voice SPS v4 or Harper Valley comparison, then multi-host build receipts, endpoint-ground-truth checks, and live capture validation. Do not change defaults until far-field, command safety, ownership, device, and live gates pass. Continue publisher/mobile/remote work separately (ADR-0099/0118/0119/0121).
