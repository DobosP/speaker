...
- Acquire and validate the remaining Harper Valley, EdAcc, and Common Voice private conversation/STT corpora, then run the exact four-source wrapper; AMI source preparation alone is complete. Use the public command/noise gate for hard-noise work; require a patched reset/tail-safe Moonshine build before any causal pair. Never change runtime defaults from development evidence (ADR-0112/0113/0115/0116/0117/0120).
