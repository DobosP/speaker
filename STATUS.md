...
- Treat the first pinned EdAcc archive run as deliberate inventory validation with private 16–20 GiB scratch; do not widen the generated allowlist automatically. Common Voice still needs owner term/token acceptance. Then validate both private corpora and run the exact canonical-strata wrapper; AMI and Harper source preparation are complete. Never change runtime defaults from development evidence (ADR-0112/0113/0115/0116/0117/0120/0122/0127/0130/0131/0132).
...
- Keep parakeet.cpp isolated; prioritize Common Voice SPS v4 after owner term/token acceptance, then build a separate causal LiveKit span evaluator, rematerialize the AMI proxy, obtain acoustically labelled endpoint truth, add multi-host build receipts, and perform live capture validation. Do not change defaults until far-field, command safety, ownership, device, and live gates pass. Continue publisher/mobile/remote work separately (ADR-0099/0118/0119/0121/0122/0129/0134).
