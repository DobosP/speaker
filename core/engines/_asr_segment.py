...
class ASRSegment:
    ...
    def prepend(self, blocks, alternate_blocks=None, *, speech_at: Optional[float] = None) -> int:
        ...
        if n:
            ...
            if self.first_speech_at is None:
                self.first_speech_at = at
            self.last_speech_at = max(self.last_speech_at or at, at)
