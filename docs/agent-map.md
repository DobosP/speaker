...
| Isolated streaming-STT benchmark | `tools/streaming_stt_eval.py`, `tools/streaming_stt/`, ADR-0089 | five `tests/test_streaming_stt_*.py` files; fake-only contract before any exact disposable real-candidate run |
