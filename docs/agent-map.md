...
| Isolated streaming-STT benchmark | `tools/streaming_stt_eval.py`, `tools/prepare_public_streaming_stt_corpus.py`, `tools/provision_moonshine_candidate.py`, `tools/streaming_stt/`, ADR-0089/0090 | deterministic `tests/test_streaming_stt_*.py` plus preparation/provision tests; opt-in exact smoke separately |
