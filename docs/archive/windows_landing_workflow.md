> **SUPERSEDED (2026-09-05):** the PR-only landing flow below was replaced by direct
> landing (ADR-0014, 2026-07-07) and the fleet session/publish rules (agent-ops
> ADR-0037/0077); the guard hook it describes is a machine-local, untracked file;
> `$GIT_HUB_TOKEN` was retired 2026-07-14 (`CREDENTIALS.md`). Surviving Windows facts
> live in [`../dev_guide.md`](../dev_guide.md) (Environment notes). Historical record only.
