"""
Auto-generated regression tests for session session_20260406_165119.

DO NOT EDIT MANUALLY.  Re-generate with::

    python scripts/generate_session_tests.py --session session_20260406_165119
...
SESSION_DIR = Path(__file__).parent.parent.parent / "recordings" / "session_20260406_165119"
...
def test_turn_000_no_self_interrupt():
    ...
    Recorded TTS text: ""
    Session mic RMS mean: 0.0135, echo_sim mean: 0.180
...
def test_turn_001_no_self_interrupt():
    ...
    Recorded TTS text: ""
    Session mic RMS mean: 0.0184, echo_sim mean: 0.188
...
def test_turn_002_no_self_interrupt():
    ...
    Recorded TTS text: ""
    Session mic RMS mean: 0.0146, echo_sim mean: 0.246
...
def test_turn_003_no_self_interrupt():
    ...
    Recorded TTS text: ""
    Session mic RMS mean: 0.0216, echo_sim mean: 0.259
...
def test_turn_004_no_self_interrupt():
    ...
    Recorded TTS text: ""
    Session mic RMS mean: 0.0234, echo_sim mean: 0.259
