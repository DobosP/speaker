"""Create an exact private Nemotron runtime from an offline wheelhouse."""
...
from tools.streaming_stt.wheel_lock import WheelLockError, load_wheel_lock
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "already downloaded wheelhouse. No resolver, package installer, "
            "network access, or candidate import is used."
        )
    )
